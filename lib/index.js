    ...
    return function (files, metalsmith, done) {
        ...
        var process_file = function process_file (file) {
            ...
            json.forEach(function (element) {
                ...
                var data;
                var renamed_element_wrapper = {};
                var passthrough_ob = {};

                // override "data" element name?
                renamed_element_wrapper[meta.rename_data_to || "data"] = element;

                // pass a chosen property (eg. tags) from JSON directly into page metadata
                if (meta.passthrough) {
                  passthrough_ob[meta.passthrough.to] = element[meta.passthrough.from];
                }
                data = _.extend(defaults, meta, renamed_element_wrapper, passthrough_ob);
